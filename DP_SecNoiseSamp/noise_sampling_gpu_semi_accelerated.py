...
from gfence_lib.constants import Q
from gfence_lib.dice import DiceEnsembleSampler, generate_dg_props
from gfence_lib.noise_sampling import secure_noise_sampling_gpu, plaintext_noise_sampling, reconstruct_noise
...
if __name__ == "__main__":
    ...
    noise_shares = secure_noise_sampling_gpu(tables_np, support_vals_np, N_SAMPLES, DEVICE, q=Q)
    sampled_noise = reconstruct_noise(noise_shares)
